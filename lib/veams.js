...
function addBlueprintFiles(path, name, type) {
	...
	try {
		copyFile(path + '/partials', veams.DATA.projectConfig().paths[bpType] + '/' + name, false);
		copyFile(path + '/data', veams.DATA.projectConfig().paths[bpType] + '/' + name, false);
		copyFile(path + '/scss', veams.DATA.projectConfig().paths.scss + '/' + bpType + 's/', false);
		copyFile(path + '/js', veams.DATA.projectConfig().paths.js + '/' + '/modules/' + name, false);
